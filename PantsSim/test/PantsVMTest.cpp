...
TEST_CASE("Execute", "[execute]") {
	...
	SECTION("Add unsigned") {
		...
		{
			Instruction add{ Opcode::add_, reg2int(Register::r0), make_operands(Register::r1, Register::r2) };
	...
	SECTION("Sub unsigned") {
		...
		{
			Instruction sub{ Opcode::sub_, reg2int(Register::r0), make_operands(Register::r1, Register::r2) };
	...
	SECTION("Mul unsigned") {
		...
		{
			Instruction sub{ Opcode::mul_, reg2int(Register::r0), make_operands(Register::r1, Register::r2) };
			auto cont = execute(sub, regs, mem, ui);
			REQUIRE(cont == true);
			REQUIRE(regs.r0() == 6);
		}
	...
	SECTION("Mul signed") {
		...
		{
			Instruction mul{ Opcode::mul_, reg2int(Register::r0), make_operands(Register::r1, Register::r2) };
	...
	SECTION("Div unsigned") {
		...
		{
			Instruction div{ Opcode::div_, reg2int(Register::r0), make_operands(Register::r1, Register::r2) };
